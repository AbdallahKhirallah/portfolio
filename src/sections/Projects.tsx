    ...
    <section id="projects" className="py-24 px-6 md:px-16 lg:px-32">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {projects.map((project) => (
          <div
            key={project.title}
            className="project-card bg-card border border-border rounded-lg p-6 flex flex-col gap-4 hover:border-gold hover:-translate-y-2 hover:shadow-xl transition-all duration-300"
          >
