...
export default function Contact() {
  return (
    <section id="contact" className="py-24 px-6 md:px-16 lg:px-32 max-w-2xl mx-auto text-center">
      ...
      <a
        href={`mailto:${email}`}
        className="inline-block border border-gold text-gold font-display font-medium px-8 py-4 rounded hover:bg-gold hover:text-base transition-colors duration-200"
      >
        Say Hello
      </a>
